...
1. Locate the data within the page and extract it.
1. Organise the data into a dataframe.
1. Load more data.
1. Do stats on it.
...
1. Get better html selectors process to avoid having to remove duplicated data
1. Improve format of data as in table above
1. Scrape new web pages
1. Investigate rvest
