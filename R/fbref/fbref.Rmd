...
players %>%
  ...
  geom_segment(aes(y=Player,yend=Player,x=0,xend=MinStart),colour=col_dark[8],size=2,alpha=0.8) +
  geom_segment(aes(y=Player,yend=Player,x=MinStart,xend=Min),colour=col_medium[8],size=2,alpha=0.4) +
  theme_sfc() +
