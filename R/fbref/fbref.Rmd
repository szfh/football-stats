...
squad %>%
  ggplot(aes(x=PPM,y=`1/3`,colour=Squad)) +
  geom_point() +
  geom_text_repel(aes(label=Squad),size=3) +
  theme_epl() +
  scale_colour_manual(values=palette_epl())
...
matches_long %>%
  ...
  geom_segment(aes(x=0,xend=xGF,y=Wk,yend=Wk),size=3,colour="red") +
  geom_segment(aes(x=0,xend=-xGA,y=Wk,yend=Wk),size=3,colour="green") +
  theme_epl() +
