...
file.remove(here::here("images","plot5.jpg"))
file.remove(here::here("images","plot6.jpg"))
file.copy(from=here::here("plots","league","xg_team.jpg"),to=here::here("images","plot1.jpg"))
file.copy(from=here::here("plots","team","xg_trend.jpg"),to=here::here("images","plot2.jpg"))
file.copy(from=here::here("plots","team","subs.jpg"),to=here::here("images","plot3.jpg"))
file.copy(from=here::here("plots","CPL","player_event_share.jpg"),to=here::here("images","plot4.jpg"))
file.copy(from=here::here("plots","team","team_appearances.jpg"),to=here::here("images","plot5.jpg"))
file.copy(from=here::here("plots","test","age_contract.jpg"),to=here::here("images","plot6.jpg"))
```
