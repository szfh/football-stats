...
get_team_players_stats(source[[1]],source[[2]]) %>%
  ...
  geom_point(colour="#e61919",alpha=0.6) +
  geom_text_repel(aes(label=player_name),size=2) +
  labs(title=paste0("Key passes per 90 ",as.integer(source[[2]]),"-",as.integer(source[[2]])+1),x="Minutes",y="Key passes per 90")
ggsave(paste0("./plots/",source[[2]],"/",source[[1]],"_keypasses_per_90_point.jpg"))
